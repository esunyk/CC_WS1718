...
enum Type {
s, source_file, package_declaration, import_declaration, import_path, toplevel_declaration, function_name, function, signature_rest, function_body, package_name,
line, addition, func_call, assignment, left_hand, right_hand, Terminal
};
...
private:
	...
	Type token;
	std::string value; //TO DO: make own type instead of string
